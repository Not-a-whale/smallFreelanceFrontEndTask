...
use TMS::Test::Core::FinAccountTypesTreeStructure;
...
my $inst = TMS::Test::Core::FinAccountTypesTreeStructure->with_traits('TMS::API::Core::FinAccountTypesTreeStructureStrict')->new();
say Dumper($inst);
$inst->Create;
$inst->Tell(undef);
