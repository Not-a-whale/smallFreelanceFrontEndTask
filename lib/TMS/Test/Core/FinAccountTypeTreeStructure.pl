...
use TMS::Test::Core::FinAccountTypeTreeStructure;
...
my $inst = TMS::Test::Core::FinAccountTypeTreeStructure->with_traits('TMS::API::Core::FinAccountTypeTreeStructureStrict')->new();
say Dumper($inst);
$inst->Create;
$inst->Tell(undef);
