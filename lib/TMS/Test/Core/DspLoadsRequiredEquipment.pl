...
use TMS::Test::Core::DspLoadsRequiredEquipment;
...
my $inst = TMS::Test::Core::DspLoadsRequiredEquipment->with_traits('TMS::API::Core::DspLoadsRequiredEquipmentStrict')->new();
say Dumper($inst);
$inst->Create;
$inst->Tell(undef);
