...
has 'MenuItemId' => ('is' => 'rw', 'isa' => 'PositiveInt',      'required' => '1', 'default' => '0');
has 'ParentId'   => ('is' => 'rw', 'isa' => 'PositiveInt',      'required' => '0');
has 'Path'       => ('is' => 'rw', 'isa' => 'TidySpacesString', 'required' => '0');
...
has '_dbix_class' =>
    (is => 'ro', required => 1, isa => 'Str', init_arg => undef, default => 'AppMenuItemWithDepth');
