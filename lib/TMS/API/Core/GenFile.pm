...
has 'DocumentTitle' => ('is' => 'rw', 'isa' => 'VarChar255',       'coerce' => '1', 'required' => '0');
has 'ExpiredDate'   => ('is' => 'rw', 'isa' => 'DATETIME',         'coerce' => '1', 'required' => '0');
has 'FileId'        => ('is' => 'rw', 'isa' => 'PrimaryKeyInt',    'coerce' => '1', 'required' => '0');
has 'FileName'      => ('is' => 'rw', 'isa' => 'VarChar1024',      'coerce' => '1', 'required' => '0');
has 'Keywords'      => ('is' => 'rw', 'isa' => 'VarChar1024',      'coerce' => '1', 'required' => '0');
has 'MIMEType'      => ('is' => 'rw', 'isa' => 'VarChar1024',      'coerce' => '1', 'required' => '0');
...
has 'ent_businesses'              => ('is' => 'rw', 'isa' => 'ArrayObjEntBusiness',             'coerce' => '1', 'required' => '0');
has 'ent_carriers'                => ('is' => 'rw', 'isa' => 'ArrayObjEntCarrier',              'coerce' => '1', 'required' => '0');
has 'ent_carriers_agreement_files' => ('is' => 'rw', 'isa' => 'ArrayObjEntCarrier',             'coerce' => '1', 'required' => '0');
