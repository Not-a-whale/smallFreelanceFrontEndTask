package TMS::API::Core::MsgDspTrip;
...
has 'idmsg_dsp_trips' => ('is' => 'rw', 'isa' => 'PrimaryKeyInt', 'coerce' => '1', 'required' => '0');
...
has '_dbix_class' => (is => 'ro', required => 1, isa => 'Str', init_arg => undef, default => 'MsgDspTrip');
