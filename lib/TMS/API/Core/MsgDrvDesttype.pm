package TMS::API::Core::MsgDrvDesttype;
...
has 'idmsg_drv_desttypes' => ('is' => 'rw', 'isa' => 'PrimaryKeyInt', 'coerce' => '1', 'required' => '0');
...
has '_dbix_class' => (is => 'ro', required => 1, isa => 'Str', init_arg => undef, default => 'MsgDrvDesttype');
