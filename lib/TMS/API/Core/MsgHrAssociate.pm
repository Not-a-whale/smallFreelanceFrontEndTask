package TMS::API::Core::MsgHrAssociate;
...
has 'idmsg_hr_associates' => ('is' => 'rw', 'isa' => 'PrimaryKeyInt', 'coerce' => '1', 'required' => '0');
...
has '_dbix_class' => (is => 'ro', required => 1, isa => 'Str', init_arg => undef, default => 'MsgHrAssociate');
