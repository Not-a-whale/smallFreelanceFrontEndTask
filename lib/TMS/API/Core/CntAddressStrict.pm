...
has 'AddrType' => ('is' => 'rw', 'isa' => 'set_AddrType',         'coerce' => '1', 'required' => '0', 'default' => 'physical,mail');
has 'Country'  => ('is' => 'rw', 'isa' => 'SupportedCountryName', 'coerce' => '1', 'required' => '1', 'default' => 'United States');
