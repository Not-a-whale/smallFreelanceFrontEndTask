...
has PaymentTermId   => (is => 'rw', coerce => 1, required => 0, isa => Undef | 'PrimaryKeyInt',);
...
has DiscountAmount  => (is => 'rw', coerce => 0, required => 0, isa => Undef | 'Int',);
has DiscountPercent => (is => 'rw', coerce => 1, required => 0, isa => Undef | 'Float',);
has DiscountInDays  => (is => 'rw', coerce => 1, required => 0, isa => Undef | 'Float',);
has Type            => (is => 'rw', coerce => 0, required => 1, isa => Undef | 'EnumStandard',);
