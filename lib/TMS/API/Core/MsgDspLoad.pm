package TMS::API::Core::MsgDspLoad;
...
has 'idmsg_dsp_loads' => ('is' => 'rw', 'isa' => 'PrimaryKeyInt', 'coerce' => '1', 'required' => '0');
...
has '_dbix_class' => (is => 'ro', required => 1, isa => 'Str', init_arg => undef, default => 'MsgDspLoad');
