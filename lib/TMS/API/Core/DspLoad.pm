...
has BrokerId       => (is => 'rw', coerce => 0, required => 1, isa => Undef | 'EntCustomerObj',);
has ShipperId      => (is => 'rw', coerce => 0, required => 0, isa => Undef | 'EntShipperObj',);
has BookedBy       => (is => 'rw', coerce => 0, required => 0, isa => Undef | 'HrAssociateObj',);
...
has Job            => (is => 'rw', coerce => 0, required => 0, isa => Undef | 'FinJobObj',);
