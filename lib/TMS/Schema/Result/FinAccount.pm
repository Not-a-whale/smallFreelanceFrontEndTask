...
__PACKAGE__->has_many(
    "fin_accounts_trees_ancestors", "TMS::Schema::Result::FinAccountsTree",
    {"foreign.AncestorId" => "self.AccountId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
__PACKAGE__->has_many(
    "fin_accounts_trees_descendants", "TMS::Schema::Result::FinAccountsTree",
    {"foreign.DescendantId" => "self.AccountId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
__PACKAGE__->has_many(
    "fin_item_template_credit_accounts", "TMS::Schema::Result::FinItemTemplate",
    {"foreign.CreditAccountId" => "self.AccountId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
__PACKAGE__->has_many(
    "fin_item_template_debit_accounts", "TMS::Schema::Result::FinItemTemplate",
    {"foreign.DebitAccountId" => "self.AccountId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
__PACKAGE__->has_many(
    ...
    {"foreign.AccountId" => "self.AccountId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:caBSD6HqDUekFYXLtzM9QA
