use utf8;
package TMS::Schema::Result::AppMenuActionTree;
...
=head1 TABLE: C<app_menu_action_trees>

=cut

__PACKAGE__->table("app_menu_action_trees");
...
__PACKAGE__->belongs_to(
  "descendant",
  "TMS::Schema::Result::AppMenuAction",
  { MenuActionId => "DescendantId" },
  { is_deferrable => 1, on_delete => "RESTRICT", on_update => "CASCADE" },
);


# Created by DBIx::Class::Schema::Loader v0.07049 @ 2019-08-05 10:27:47
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AtWPlTKc+FLK2ZyFTeNcjw
