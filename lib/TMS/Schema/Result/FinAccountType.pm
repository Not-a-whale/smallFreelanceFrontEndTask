...
__PACKAGE__->has_many(
  "fin_account_types_trees_ancestors",
  "TMS::Schema::Result::FinAccountTypesTree",
  { "foreign.AncestorId" => "self.AccountTypeId" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
__PACKAGE__->has_many(
  "fin_account_types_trees_descendants",
  "TMS::Schema::Result::FinAccountTypesTree",
  { "foreign.DescendantId" => "self.AccountTypeId" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SYDTjNBJTqZ3PeP0LO+6fQ
