...
__PACKAGE__->add_columns("Name", {accessor => "name", data_type => "varchar", is_nullable => 0, size => 255},);
...
__PACKAGE__->has_many(
    ...
    {"foreign.CommissionPackage" => "self.Name"}, {cascade_copy => 0, cascade_delete => 0},
);
...
__PACKAGE__->has_many(
    "cmm_package_tiers", "TMS::Schema::Result::CmmPackageTier",
    {"foreign.Package" => "self.Name"}, {cascade_copy => 0, cascade_delete => 0},
);

# Created by DBIx::Class::Schema::Loader v0.07049 @ 2019-12-26 15:33:20
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mdc3OgzYlzjrvGbeweRg2Q
