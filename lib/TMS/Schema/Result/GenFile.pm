...
__PACKAGE__->has_many(
    ...
    {"foreign.CrrPrmtAccDoc" => "self.FileId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
__PACKAGE__->has_many(
    "crr_permit_images", "TMS::Schema::Result::CrrPermitImage",
    {"foreign.PermtImageId" => "self.FileId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
__PACKAGE__->has_many(
    ...
    {"foreign.Photo" => "self.FileId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
__PACKAGE__->has_many(
    ...
    {"foreign.VoidCheck" => "self.FileId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
__PACKAGE__->has_many(
    "inv_equipment_docs", "TMS::Schema::Result::InvEquipmentDoc",
    {"foreign.FileId" => "self.FileId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
__PACKAGE__->has_many(
    ...
    {"foreign.FileRef" => "self.FileId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
__PACKAGE__->has_many(
    ...
    {"foreign.InspectorSignatureId" => "self.FileId"}, {cascade_copy => 0, cascade_delete => 0},
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SUGbxHhxpIxobDu3l6V7Vg
