...
__PACKAGE__->has_many(
  "fin_item_templates_trees_ancestors",
  "TMS::Schema::Result::FinItemTemplatesTree",
  { "foreign.AncestorId" => "self.ItemTemplateId" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
__PACKAGE__->has_many(
  "fin_item_templates_trees_descendants",
  "TMS::Schema::Result::FinItemTemplatesTree",
  { "foreign.DescendantId" => "self.ItemTemplateId" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:YnoJfpNfsniimYaZdjI5lw
