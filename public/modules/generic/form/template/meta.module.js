class MetaFormTemplateCtrl {
  ...
  DisableForm(form) {
    if (form != undefined) {
      console.log("Meta Template form disabling: " + form.title);
      form.enabled = false;
      this.SetAnchor(this.currf);
    }
  }
...
var meta_formtemplate_bindings = CloneObj(meta_bindings);
app.controller("MetaFormTemplateCtrl", [MetaFormTemplateCtrl]);
app.component("metaTemplateForm", {
  templateUrl: "modules/generic/form/template/meta.template.html",
  controller: "MetaFormTemplateCtrl",
  bindings: meta_formtemplate_bindings
});