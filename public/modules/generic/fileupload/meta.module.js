class MetaFileUploadCtrl extends MetaInputCtrl {
...
var meta_fileupload_bindings = JSON.parse(JSON.stringify(input_bindings));
meta_fileupload_bindings.maxFiles = '@';
meta_fileupload_bindings.url = '<?';

app.controller('MetaFileUploadCtrl', ['getid', '$scope', '$http', 'FileReaderExt', MetaFileUploadCtrl])
app.component('metaFileUpload', {
  templateUrl: 'modules/generic/fileupload/meta.template.html',
  controller: 'MetaFileUploadCtrl',
  bindings: meta_fileupload_bindings
});